...
let setFruits = {
  startFruits: [0, 1, 2, 3, 4, 5], // 指定前几次生成的水果，可填入任意数量的数字
  randomFunction: () => {
...
let adLink = 'https://www.bilibili.com/video/BV1op4y1W75A?from=search&seid=12268355702750964727';

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '合成中南大';
